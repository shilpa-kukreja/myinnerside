...
// // Add this to your initializeSocket function
...
// // Add these call response functions to your component
...
//   try {
//     setAppointmentId(appointmentId);
//     setCallStatus('calling'); // Changed from 'connecting' to 'calling'
...
//     // Initialize peer connection but don't set up offer yet
//     setupPeerConnection(stream);

//     // Emit call request instead of directly joining
...
//         // Clean up media if call wasn't accepted
//         if (localStream) {
...
//     socketRef.current.on('call-accepted', onCallAccepted);
//     socketRef.current.on('call-rejected', onCallRejected);

//     // Cleanup listeners when component unmounts or call ends
//     return () => {
//       clearTimeout(callTimeout);
//       socketRef.current?.off('call-accepted', onCallAccepted);
//       socketRef.current?.off('call-rejected', onCallRejected);
//     };

//   } catch (error) {
//     console.error('Error starting call:', error);
//     setCallStatus('error');
//     // Clean up media if there was an error
//     if (localStream) {
//       localStream.getTracks().forEach(track => track.stop());
//       setLocalStream(null);
//     }
