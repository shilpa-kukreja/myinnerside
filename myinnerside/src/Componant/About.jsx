          ...
          <div className="about_myinnerside">
            ...
            <div className="col-half">
              <div className="about_info">
                ...
                <p className='para'> My Inner Side a service provided by Swarnim Bharat with an idea of giving that privacy to the customers where they feel comfortable to discuss what they are not able to discuss with the people they know personally. We provide sessions where they can vent their Heart Out. We keep details and sessions confidential to protect our client’s identity and emotions shared.</p>
                <p className='para'>
